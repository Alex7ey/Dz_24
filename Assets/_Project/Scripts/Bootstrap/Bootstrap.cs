...
public class Bootstrap : MonoBehaviour
{
    ...
    {
        character.GetComponent<ViewCharacter>().Initialize(character);
        ...
        _controllerUpdater.Initialize(new PointClickMovementController(character), new NavMeshAgentJumpController(character));
    }
}
